...
if [ -f data/.env ]; then
    ...
    [ -z "$DB_USERNAME" ] && DB_USERNAME="ciuser_$(generate_random 8)"
    [ -z "$DB_PASSWORD" ] && DB_PASSWORD="$(generate_random 32)"
    [ -z "$DB_NAME" ] && DB_NAME="certellix"
    ...
    DB_USERNAME="ciuser_$(generate_random 8)"
...
echo
echo "Thank you for using Certellix!"
